<x-filament-panels::page>
    <div class="text-center py-12">
        <div class="inline-flex items-center justify-center w-24 h-24 rounded-full {{ $isOnline ? 'bg-success-100 text-success-600' : 'bg-danger-100 text-danger-600' }} mb-4">
            @if($isOnline)
                <x-heroicon-o-signal class="w-12 h-12" />
            @else
